...
@Component({
  selector: 'app-gestao-esmaltacao-inventario',
  templateUrl: './gestao-esmaltacao-inventario.component.html',
  styleUrls: ['./gestao-esmaltacao-inventario.component.scss']
})
export class GestaoEsmaltacaoInventarioComponent implements OnInit {
