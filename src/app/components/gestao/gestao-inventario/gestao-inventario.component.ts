...
@Component({
  selector: 'app-gestao-inventario',
  templateUrl: './gestao-inventario.component.html',
  styleUrls: ['./gestao-inventario.component.scss']
})
export class GestaoInventarioComponent implements OnInit {
